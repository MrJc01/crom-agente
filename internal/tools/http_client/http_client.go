...
func init() {
	...
	if err != nil {
		panic("falha ao carregar metadados de http_client: " + err.Error())
	}
}
...
func (t *HTTPClientTool) ID() string { return metadata.ID }
	...
	return json.RawMessage(`{
		...
		"properties": {
			"method": {
				"type": "string",
				"enum": ["GET", "POST"],
				"description": "Mét odo HTTP (GET ou POST)",
				"default": "GET"
			},
			"url": {
				"type": "string",
...
func (t *HTTPClientTool) Execute(ctx context.Context, args json.RawMessage) (tools.Result, error) {
	...
	if method != "GET" && method != "POST" {
		return tools.Result{Success: false, Error: "método HTTP não suportado. Apenas GET e POST são permitidos."}, nil
	}
	...
	if err != nil {
		return tools.Result{Success: false, Error: "erro ao ler corpo da resposta: " + err.Error()}, nil
	}
